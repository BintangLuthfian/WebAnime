...
const Sidebar = () => {
  ...
  const Menus = [
    ...
    { title: "Anime", src: "home", path: "/daftar" },
    { title: "Data", src: "home", path: "/datauser" },
    ...
    <div className="flex fixed top-0 z-50">
      ...
      >
        <img
          ...
          className={`absolute cursor-pointer -right-3 top-[90px] w-7 border-dark-purple
        ...
        <Link to="/">
          <div className="flex gap-x-3 items-center absolute top-5 left-2 w-[70px]">
            ...
            />
            <div className={`transition-all ${!open && "opacity-0"}`}>
              <h1
              ...
              <p
                ...
                style={{ fontFamily: "Josefin Sans, sans-serif", textAlign: "center"}}
              >
                Administrasi
              </p>
            </div>
